package de.reiss.bible2net.theword2.main.viewpager
...
import de.reiss.bible2net.theword2.downloader.file.DownloadProgressListener
...
import de.reiss.bible2net.theword2.logger.logInfo
import de.reiss.bible2net.theword2.logger.logWarn
import de.reiss.bible2net.theword2.twdparser.TwdItem
import de.reiss.bible2net.theword2.twdparser.TwdParser
import de.reiss.bible2net.theword2.util.extensions.amountOfDaysInRange
import de.reiss.bible2net.theword2.util.extensions.asDateString
import de.reiss.bible2net.theword2.util.extensions.extractYear
...
open class ViewPagerRepository @Inject constructor(
    ...
    @WorkerThread
    private fun downloadAndStoreItems(
        bible: String,
        fromDate: Date,
        toDate: Date
    ): Boolean {
